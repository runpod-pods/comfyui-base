...
- **Ubuntu 22.04 → 24.04** for both regular and 5090 images. Python 3.12 is now provided by the base OS (deadsnakes PPA no longer needed).
- **CUDA upgraded**: regular image now uses CUDA 12.8 (cu128 wheels), 5090 image uses CUDA 13.0 (cu130 wheels). CUDA 12.4 is no longer supported.
